...
import com.nowcoderstudy.webcommunity.dao.MessageMapper;
...
public class MapperTests {
    ...
    public void testSelectLetters() {
        ...
        List<Message> list = messageMapper.selectConversations(4, 0, 20);
        for (Message message : list) {
            System.out.println(message);
        }

        int count = messageMapper.selectConversationCount(4);
        System.out.println(count);

        list = messageMapper.selectLetters("4-5", 0, 10);
        for (Message message : list) {
            System.out.println(message);
        }

        count = messageMapper.selectLetterCount("4-5");
        System.out.println(count);
